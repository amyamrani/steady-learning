      ...
      <div className='page-container'>
        ...
        <section className="landing-section">
          <div className="landing-section__content">
            ...
            <p className='section-description'>Steady Learning helps you learn a range of topics by providing you with small units of information on a daily basis for a short-term period</p>
